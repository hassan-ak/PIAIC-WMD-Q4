...
from topic import Question, Option, SingleSelectMCQ, MultipleSelectMCQ, CaseStudy


class Quiz:
    def __init__(
        self, quizID: str, student: Student, subpath: str, quizTitle: str
    ) -> None:
...
class Answer(ABC):
    def __init__(
        self, answerSheetID: str, answerID: str, pointsReceived: float = 0
    ) -> None:
        self.answerSheetID = answerSheetID
