...
class Question(ABC):
    def __init__(
        self, topicID: str, questionID: str, title: str, text: str, points: int = 1
    ) -> None:
        self.topicID: str = topicID
...
class Option:
    def __init__(
        self, questionID: str, optionID: str, text: str, correct: bool
    ) -> None:
...
class MCQ(Question):
    def __init__(
        self, questionBankID: str, topicID: str, questionID: str, title: str, text: str
    ) -> None:
